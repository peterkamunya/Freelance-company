...
<body style="background-image: url('image/pexels-elijahsad-4066041.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%;"></body>
<section class="form-container">
    <form action="" method="post"  action="resetpassword.php">
